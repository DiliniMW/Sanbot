...
public class ChoiceActivity extends TopBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MySettings.initializeSpeak();
            ...
            Thread objBgThread4=new Thread(objrunnable4);
            objBgThread4.start();
    ...
    public void productionSpeech(){
        Toast.makeText(ChoiceActivity.this, "Production details", Toast.LENGTH_SHORT).show();
        systemManager.showEmotion(EmotionsType. SMILE);
        //say hi
        mediaPlayer1.start();
        Toast.makeText(ChoiceActivity.this, "Production", Toast.LENGTH_SHORT).show();
    }
    ...
    public void handmotions(){
        ...
        delayHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                wingMotionManager.doNoAngleMotion(noAngleWingMotionDOWNRight);
            }
        }, 6000);
