...
public class Production4 extends TopBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.iiot;
            ...
            videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    finish();
                    Intent intent = new Intent(Production4.this, SelectActivity.class);
            ...
            hardWareManager.setOnHareWareListener(new ObstacleListener() {
                ...
                public void onObstacleStatus(boolean b) {
                    if (!b && available4==true) {
                        Toast.makeText(Production4.this, "No One here", Toast.LENGTH_SHORT).show();
                        available4=false;
                        Intent intent = new Intent(Production4.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
