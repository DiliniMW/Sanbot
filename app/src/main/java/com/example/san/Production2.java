...
public class Production2 extends TopBaseActivity {
    ...
    private static boolean available3=true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Thread objBgThread2=new Thread(objrunnable2);
            objBgThread2.start();
            ...
            String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.racconali;
            ...
            videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    finish();
                    Intent intent = new Intent(Production2.this, SelectActivity.class);
        ...
        public void run() {
            ...
            hardWareManager.setOnHareWareListener(new ObstacleListener() {
                ...
                public void onObstacleStatus(boolean b) {
                    if (!b && available3==true) {
                        Toast.makeText(Production2.this, "No One here", Toast.LENGTH_SHORT).show();
                        available3=false;
                        Intent intent = new Intent(Production2.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
