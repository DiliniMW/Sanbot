...
public class Production5 extends TopBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.univo;
            ...
            videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    finish();
                    Intent intent = new Intent(Production5.this, SelectActivity.class);
            ...
            hardWareManager.setOnHareWareListener(new ObstacleListener() {
                ...
                public void onObstacleStatus(boolean b) {
                    if (!b && available4==true) {
                        Toast.makeText(Production5.this, "No One here", Toast.LENGTH_SHORT).show();
                        available4=false;
                        Intent intent = new Intent(Production5.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
