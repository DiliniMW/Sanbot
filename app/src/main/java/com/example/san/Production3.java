...
public class Production3 extends TopBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Thread objBgThread3=new Thread(objrunnable3);
            objBgThread3.start();
            ...
            String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.agro;
            ...
            videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    finish();
                    Intent intent = new Intent(Production3.this, SelectActivity.class);
        ...
        public void run() {
            ...
            hardWareManager.setOnHareWareListener(new ObstacleListener() {
                ...
                public void onObstacleStatus(boolean b) {
                    if (!b && available2==true) {
                        Toast.makeText(Production3.this, "No One here", Toast.LENGTH_SHORT).show();
                        available2=false;
                        Intent intent = new Intent(Production3.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
