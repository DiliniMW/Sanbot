...
public class  SequenceActivity extends TopBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            mediaPlayer4 = MediaPlayer.create(this, R.raw.goodbuy);
            mediaPlayer4.start();
            GifImageView gifImageView = findViewById(R.id.gifbackground1);
    ...
    public void emotions(){
        ...
        //smile emotion
        Toast.makeText(SequenceActivity.this, "SMILE", Toast.LENGTH_SHORT).show();
