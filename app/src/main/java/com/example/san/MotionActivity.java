...
public class  MotionActivity extends TopBaseActivity {
    ...
    WheelMotionManager wheel=(WheelMotionManager)getUnitManager(FuncConstant.WHEELMOTION_MANAGER);
    //head motion
    ...
    NoAngleWheelMotion noAngleWheelMotion= new NoAngleWheelMotion(NoAngleWheelMotion.ACTION_FORWARD, 5,50000);
    ...
    DistanceWheelMotion distanceWheelMotionforward= new DistanceWheelMotion(DistanceWheelMotion.ACTION_FORWARD_RUN,5,100);
    ...
    public void distanceLeftForward(){
        wheelMotionManager.doDistanceMotion(distanceWheelMotionfright);
        sleepy(0.5);

    }

    public void distanceRightForward(){
        wheelMotionManager.doDistanceMotion(distanceWheelMotionfleft);
        sleepy(0.5);
        ...
        hardWareManager.setOnHareWareListener(new ObstacleListener() {
            ...
            public void onObstacleStatus(boolean b) {
                if(b && find==true){
                    ...
                    speechManager.startSpeak("Moving Stop", MySettings.getSpeakDefaultOption());
                    concludeSpeak(speechManager);
                }else{
                    distanceLeftForward();
                    find = false;
