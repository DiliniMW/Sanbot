...
public class  inquiries extends TopBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
           ...
           // handmotions();
            ...
            mediaPlayer3 = MediaPlayer.create(this, R.raw.feedback);
            mediaPlayer3.start();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent intent = new Intent(inquiries.this, RaffelDraw.class);
            ...
            exitButton2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    wingMotionManager.doNoAngleMotion(new NoAngleWingMotion(NoAngleWingMotion.PART_BOTH, 5, NoAngleWingMotion.ACTION_RESET));
                    finish();
                    Intent intent = new Intent(inquiries.this, ChoiceActivity.class);
                    startActivity(intent);
                }
            });
